...
export default function Home(props) {
  ...
  useEffect(() => {
    fetch('https://accounts.spotify.com/api/token', {
      method: 'POST',
      body: `grant_type=client_credentials&client_id=${SPOTIFY_CLIENT_ID}&client_secret=${SPOTIFY_CLIENT_SECRET}&redirect_uri=${encodeURIComponent("https://soundwiseoriginal.onrender.com")}`,
      headers: {
